...
function (base_size = 12, base_family = "") 
{
  ...
  theme(
    ...
    rect = element_rect(fill = "ivory", colour = "ivory2",
                        size = 0.5, linetype = 1),
    text = element_text(family = base_family, face = "plain",
                        colour = "grey35", size = base_size,
    ...
    panel.background = element_rect(fill = "ivory", colour = NA),
    panel.border = element_blank(), 
    panel.grid.major = element_line(colour = "slategrey"), 
    panel.grid.minor = element_line(colour = "slategrey", size = 0.25), 
